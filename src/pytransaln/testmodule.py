...
class TestFrameshifts(unittest.TestCase):
    ...
    def test_report_deletions(self):
        self.assertEqual(
            ...
            [
                { "refstart": -1, "refend": -1, "origstart": 1, "origend": 1, "gaplen": 1, },
                { "refstart": -1, "refend": -1, "origstart": 4, "origend": 4, "gaplen": 1, },
                { "refstart": -1, "refend": -1, "origstart": 8, "origend": 8, "gaplen": 1, },
            ],
        )
